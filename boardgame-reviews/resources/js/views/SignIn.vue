    ...
    <div class="hero-body">
      <div class="container has-text-centered">
        ...
        <div class="column is-4 is-offset-4">
          <div class="box">
            <bdTextField type="email" placeholder="メールアドレス" icon="envelope" v-model="email"></bdTextField>
            <!-- パスワードの入力欄としてテキストフィールドコンポーネントを使用 -->
            <bdTextField type="password" placeholder="パスワード" icon="lock" v-model="password"></bdTextField>
            <div class="field">
