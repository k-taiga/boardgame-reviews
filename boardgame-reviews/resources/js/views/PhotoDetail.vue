<template>
    <div
        v-if="photo"
        class="photo-detail container"
        :class="{ 'photo-detail--column': fullWidth }"
    >
        <figure
            class="photo-detail__pane photo-detail__image image"
            @click="active = !active"
        >
        ...
        <div class="photo-detail__pane">
            ...
            <button
                ...
                @click="onLikeClick"
            >
                <bdIcon name="thumbs-up"></bdIcon>{{ photo.likes_count }}
            </button>
            ...
            <form @submit.prevent="addReview" class="form" v-if="isLogin">
                <div v-if="reviewErrors" class="errors">
                    <ul v-if="reviewErrors.content">
                        <li v-for="msg in reviewErrors.content" :key="msg">
                            {{ msg }}
                        </li>
                    </ul>
                </div>
