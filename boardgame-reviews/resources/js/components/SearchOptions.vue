        ...
        <div class="field">
          <div class="control has-icons-left">
            <span class="select is-empty">
              <select>
                <option disabled="disabled" hidden="hidden" selected>ソート順</option>
    ...
    <div class="level-right">
      ...
      <div class="level-item">
        <div class="field">
          <label class="switch">
            <span class="check">
              <el-switch v-model="value2" active-color="#13ce66" inactive-color="#b5b5b5"></el-switch>
            </span>
            <span class="control-label">
              ...
              >
                <el-tooltip content="持ち込み可のお店を探します。" placement="bottom" effect="light">
                  <el-button>
